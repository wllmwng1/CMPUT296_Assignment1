...
public class ObstacleTest5Points : ObstacleDefiner
{
	...
	public override Vector2[][] GetObstaclePoints()
	{
        ...
        Vector2[] obstacles8 = new Vector2[] { new Vector2(-1.75f, -0.95f), new Vector2(-1.76f, -0.95f), new Vector2(-1.75f, -0.96f) };

        Vector2[][] arrayOfObstaclePoints = new Vector2[][] { obstacles1, obstacles2, obstacles3, obstacles4, obstacles5, obstacles6, obstacles7, obstacles8 };
